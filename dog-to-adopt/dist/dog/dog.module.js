...
const chenil_module_1 = require("../chenil/chenil.module");
...
exports.DogModule = DogModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: dogs_shema_1.Dog.name, schema: dogs_shema_1.DogSchema }]),
            (0, common_1.forwardRef)(() => chenil_module_1.ChenilModule)
        ],
        controllers: [dog_controller_1.DogController],
        providers: [dog_service_1.DogService],
        exports: [dog_service_1.DogService]
    })
], DogModule);
